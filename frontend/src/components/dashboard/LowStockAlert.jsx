...
const LowStockAlert = ({ products }) => {
  ...
  return (
    <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-[#10b981]/30 shadow-[0_0_15px_rgba(16,185,129,0.15)] h-full overflow-hidden flex flex-col">
      <h3 className="text-[#10b981] text-lg font-semibold mb-6 flex items-center">
